...
bool ReturnOfTheMarcusAnalysis::GetAbsorptionRef(){
...
bool ReturnOfTheMarcusAnalysis::GetAbsorptionRef(int absref_ver){
...
bool ReturnOfTheMarcusAnalysis::GetAbsorptionRef(std::string filename){
...
bool ReturnOfTheMarcusAnalysis::GetCalibrationCurve(){
...
bool ReturnOfTheMarcusAnalysis::GetCalibrationCurveFromConfigs(){
...
bool ReturnOfTheMarcusAnalysis::GetCalibrationCurveFromFile(){
...
bool ReturnOfTheMarcusAnalysis::GetCalibrationCurveFromDB(){
	...
	// psql -U postgres -d "rundb" -c "INSERT INTO data (timestamp, tool, ledname, name, values) VALUES ('now()', 'ReturnOfTheMarcusAnalysis', '275_A', 'calibration_curve', '{\"version\":0, \"formula\":\"pol6\", \"params\":[0.0079581671, 2.7415760, -31.591756, 478.69924, 18682.891, -29982.759] }' );"
	...
	std::string query_string = "SELECT values->>'formula' FROM data WHERE name='calibration_curve'"
	                           " AND tool='ReturnOfTheMarcusAnalysis'"
	                           " AND ledname="+m_data->postgres.pqxx_quote(ledToAnalyse)+
...
bool ReturnOfTheMarcusAnalysis::GetROI(){
...
bool ReturnOfTheMarcusAnalysis::FitAbsorbance(){
...
bool ReturnOfTheMarcusAnalysis::CalculateConcentration(){
